        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="number" name="weight" id="weight" value="{{ old('weight', $product->productDetail?->weight) }}" required step="0.01" min="0"
                ...
                <div>
                    ...
                    <input type="text" name="size" id="size" value="{{ old('size', $product->productDetail?->size) }}"
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('description') border-red-500 @enderror">{{ old('description', $product->productDetail?->description) }}</textarea>
