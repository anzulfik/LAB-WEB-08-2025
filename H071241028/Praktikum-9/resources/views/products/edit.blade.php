...
<div class="max-w-3xl mx-auto">
    <div class="card">
        <h2 class="text-xl font-semibold text-gray-700 mb-4">Edit Produk</h2>
        ...
        <form action="{{ route('products.update', $product->id) }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <p id="pricePreview" class="text-sm text-gray-500 mt-1 italic">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <textarea name="description" id="description" rows="4"
                              class="w-full border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-rose-500"
                              placeholder="Tambahkan deskripsi produk...">{{ old('description', $product->detail->description ?? '') }}</textarea>
                </div>
