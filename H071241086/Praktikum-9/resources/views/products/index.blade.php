...
<div class="flex justify-between items-center mb-8">
    <div>
        <h1 class="text-4xl font-bold text-white mb-2">Daftar Produk</h1>
...
<div class="bg-cyan-500/10 border-2 border-cyan-400/40 rounded-2xl px-6 py-4 mb-6 backdrop-blur-sm">
    <p class="text-cyan-300">Hasil pencarian: <strong class="text-white">"{{ $search }}"</strong> - {{ $products->total() }} produk ditemukan</p>
</div>
@endif
        ...
        <table class="w-full">
            <thead>
                <tr class="border-b-2 border-purple-500/30">
                    <th class="py-4 px-6 text-left text-cyan-300 font-bold text-sm tracking-wider">NAMA</th>
                    <th class="py-4 px-6 text-left text-cyan-300 font-bold text-sm tracking-wider">KATEGORI</th>
                    <th class="py-4 px-6 text-left text-cyan-300 font-bold text-sm tracking-wider">HARGA</th>
            ...
            <tbody>
                ...
                <tr class="border-b border-purple-500/20 hover:bg-purple-500/5 transition-colors duration-200">
                    ...
                    <td class="py-4 px-6 text-white font-semibold">Rp {{ number_format($product->price, 2, ',', '.') }}</td>
                    <td class="py-4 px-6">
