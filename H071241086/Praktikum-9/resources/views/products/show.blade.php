...
<div class="max-w-3xl mx-auto">
    <div class="mb-6">
        ...
        <p class="text-gray-400 mt-3">Informasi lengkap tentang produk</p>
    </div>
    ...
    <div class="relative bg-[#0a0e27]/40 backdrop-blur-xl rounded-3xl overflow-hidden border border-cyan-400/20">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 gap-6">
                ...
                {{-- Kategori & Harga --}}
                <div class="grid md:grid-cols-2 gap-6 border-b border-purple-500/20 pb-4">
                    <div>
                        <label class="block text-sm font-semibold text-cyan-300 uppercase tracking-wide mb-2">
                            Kategori
                        </label>
                ...
                <div class="grid md:grid-cols-2 gap-6 border-b border-purple-500/20 pb-4">
                    <div>
                        ...
                        <p class="text-lg font-medium text-white">
                            {{ number_format($product->detail->weight, 2, ',', '.') }} kg
                        </p>
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-cyan-300 uppercase tracking-wide mb-2">
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-white font-medium mt-1">
                                    {{ $product->detail->created_at->timezone('Asia/Makassar')->format('d M Y') }}
                                </p>
                                <p class="text-sm text-green-400">
                                    {{ $product->detail->created_at->timezone('Asia/Makassar')->format('H:i') }} WITA
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-blue-500/10 rounded-2xl p-4 border-2 border-blue-400/30 backdrop-blur-sm">
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-white font-medium mt-1">
                                    {{ $product->detail->updated_at->timezone('Asia/Makassar')->format('d M Y') }}
                                </p>
                                <p class="text-sm text-blue-400">
                                    {{ $product->detail->updated_at->timezone('Asia/Makassar')->format('H:i') }} WITA
                                </p>
                            </div>
                        </div>
                    </div>
