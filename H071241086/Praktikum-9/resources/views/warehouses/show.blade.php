...
<div class="max-w-3xl mx-auto">
    <div class="mb-6">
        <h1 class="text-4xl font-bold text-white mb-2">Detail Warehouse</h1>
        <div class="h-1 w-32 bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 rounded-full"></div>
        <p class="text-gray-400 mt-3">Informasi lengkap tentang warehouse</p>
    </div>
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div class="border-b border-purple-500/20 pb-4">
                    ...
                    <p class="text-gray-300 leading-relaxed">
                        {{ $warehouse->location ?: 'Tidak ada lokasi' }}
                    </p>
                </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-white font-medium mt-1">
                                    {{ $warehouse->created_at->timezone('Asia/Makassar')->format('d M Y') }}
                                </p>
                                <p class="text-sm text-green-400">
                                    {{ $warehouse->created_at->timezone('Asia/Makassar')->format('H:i') }} WITA
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-blue-500/10 rounded-2xl p-4 border-2 border-blue-400/30 backdrop-blur-sm">
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-white font-medium mt-1">
                                    {{ $warehouse->updated_at->timezone('Asia/Makassar')->format('d M Y') }}
                                </p>
                                <p class="text-sm text-blue-400">
                                    {{ $warehouse->updated_at->timezone('Asia/Makassar')->format('H:i') }} WITA
                                </p>
                            </div>
                        </div>
                    </div>
