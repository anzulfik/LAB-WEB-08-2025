...
<div class="max-w-3xl mx-auto">
    <div class="mb-6">
        <h1 class="text-4xl font-bold text-white mb-2">Tambah Warehouse</h1>
        <div class="h-1 w-32 bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 rounded-full"></div>
        <p class="text-gray-400 mt-3">Tambahkan gudang baru ke sistem</p>
    </div>
            ...
            <form action="{{ route('warehouses.store') }}" method="POST">
                ...
                <div class="mb-8">
                    ...
                    <textarea name="location"
                              ...
                              placeholder="Masukkan lokasi warehouse (opsional)"></textarea>
                    @error('location')
                        <p class="text-red-400 text-sm mt-2">{{ $message }}</p>
                    @enderror
                </div>
