...
<div class="flex justify-between items-center mb-8">
    <div>
        <h1 class="text-4xl font-bold text-white mb-2">Daftar Kategori</h1>
...
<div class="bg-cyan-500/10 border-2 border-cyan-400/40 rounded-2xl px-6 py-4 mb-6 backdrop-blur-sm">
    <p class="text-cyan-300">Hasil pencarian: <strong class="text-white">"{{ $search }}"</strong> - {{ $categories->total() }} kategori ditemukan</p>
</div>
@endif
        ...
        <table class="w-full">
            <thead>
                <tr class="border-b-2 border-purple-500/30">
                    ...
                    <th class="py-4 px-6 text-left text-cyan-300 font-bold text-sm tracking-wider">DESKRIPSI</th>
            ...
            <tbody>
                ...
                <tr class="border-b border-purple-500/20 hover:bg-purple-500/5 transition-colors duration-200">
                    <td class="py-4 px-6 text-white font-medium">{{ $category->name }}</td>
                ...
                <tr>
                    <td colspan="3" class="py-12 px-6 text-center">
                        <div class="text-gray-400 text-lg">
                            @if($search)
                                Tidak ada kategori yang ditemukan untuk "{{ $search }}"
                            @else
